...
<div class="contact">
    <div class="backgroundemail"></div>
    <form action="" id="contactform">
    <div class="flex flex-col justify-center items-center">
    <h1>Get in Touch</h1>
    <p>Write us a message ,and sooner or later we will be in Touch with you !!! , Keep it up</p>
    </div>
    <textarea name="message" placeholder="What can we help you with?*" id="" cols="43" rows="5"></textarea>
    <button>Send</button>
    </form>
</div>
